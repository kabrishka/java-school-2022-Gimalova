...
public class Parser {
    ...
    public static void parseFromFile(String path) throws Exception {
        try(BufferedReader r = new BufferedReader(new FileReader(path))) {
            try(DBQuery query = new DBQuery(Objects.requireNonNull(DBConnection.getDBConnection()))) {
                query.deleteDbTable();
                query.createDbTable();
                String line;
                while((line = r.readLine()) != null) {
                    ...
                    Order order = new Order(currUserId,currProductId);
